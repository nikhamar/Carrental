...
*/
    ...
    body{
        ...
        font-size: 100%;
        background: url("http://www.hd-freeimages.com/uploads/large/hd-car-wallpapers/free-3d-car-wallpapers-download.jpg")no-repeat center top;
...
<div>
    ...
    <div>
        <l><b><c><a class="active" href="#home">Home</a></c></b></l>
        <l><b><c><a href="#news">Login</a></c></b></l>
    ...
    <div class="book-reservation">
        <form action="/traveldetails" method="post">
            <div class="form-date-w3-agileits">
                <label><i class="fa fa-user" aria-hidden="true"></i> PickUp Locatio n</label>
                <input type="text" name="pickuplocation" placeholder="Enter Pickup Location" required=""/>
            </div>
            <div class="form-date-w3-agileits">
                <label><i class="fa fa-envelope" aria-hidden="true"></i>DropOff Location</label>
            ...
            <div class="form-date-w3-agileits">
                ...
                <input  id="datepicker1" name="pickupDate" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
            </div>
            ...
            <!--</div>-->
            <div class="form-time-w3layouts">
                <label><i class="fa fa-calendar" aria-hidden="true"></i> Dropoff Date :</label>
                <input  id="datepicker2" name="dropOffDate" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
            </div>
            <div class="form-time-w3layouts">
                <label><i class="fa fa-calendar" aria-hidden="true"></i> Age :</label>
                <input  id="datepicker3" name="age" type="text" value="Age" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Age';}" required="">
            </div>
...
<!--copyright-->
<div class="copy w3ls">
    <p>Copyright 2018 All Rights Reserved  | Design by <a href="#" target="_blank">Nikhil</a> </p>
</div>
<!--//copyright-->
